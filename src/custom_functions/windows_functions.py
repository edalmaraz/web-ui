...
async def get_installed_software() -> ActionResult:
    ...
    get_software_from_key(r"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall")
...
async def set_window_position(window_title: str, x: int, y: int, width: int, height: int) -> ActionResult:
