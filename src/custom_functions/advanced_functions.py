...
async def extract_table_data(
    browser: BrowserContext, table_selector: str
) -> ActionResult:
    """
...
async def execute_custom_javascript(
    browser: BrowserContext, script: str
) -> ActionResult:
    """
...
async def wait_for_network_idle(
    browser: BrowserContext, timeout: int = 5000
) -> ActionResult:
    """
...
async def monitor_network_requests(
    browser: BrowserContext, url_pattern: Optional[str] = None
) -> ActionResult:
    """
