...
class Director(Agent):
    ...
    async def delegate_task(self, task: Dict) -> Dict:
        ...
        return {"resources": resources, "sub_director_results": results}
...
class SubDirector(Agent):
    ...
    async def handle_task(self, task: Dict, resources: Dict) -> Dict:
        ...
        return {"manager_count": len(self.managers), "results": results}
...
class Manager(Agent):
    ...
    async def handle_task(self, task: Dict, resources: Dict) -> Dict:
        ...
        return {"agent_count": len(self.agents), "results": results}
...
class WorkerAgent(Agent):
    ...
    async def process_task(self, task: Dict) -> Dict:
        ...
        return {"agent_id": self.id, "task_id": task["id"], "result": result}
...
class AgentSystem:
    ...
    async def process_task(self, task: Dict) -> Dict:
        ...
        if self.double_check_mode:
            ...
            if not self._results_match(agent_results):
                ...
                reconciled_results = await self._reconcile_results(
                    task_id, agent_results
                )
    ...
    def _results_match(self, results: List[Dict]) -> bool:
        ...
        return all(
            json.dumps(r["result"], sort_keys=True) == first_result for r in results
        )

    async def _reconcile_results(self, task_id: str, results: List[Dict]) -> Dict:
